...
class DuelingDQN:
    ...
    def plot_cost(self,name= 'RL'):
        ...
        np.save('.\\dataDueling\\NNcost'+name+'.npy',np.array(self.cost_his))
        plt.ylabel('Cost')
        plt.xlabel('training steps')
        plt.savefig('.\\dataDueling\\'+name+'cost.svg',format='svg',dpi=400)
        plt.savefig('.\\dataDueling\\'+name+'cost.png',format='png',dpi=400) 