...
class DoubleDQN:
    ...
    def plot_cost(self,name= 'RL'):
        ...
        np.save('.\\dataDouble\\NNcost'+name+'.npy',np.array(self.cost_his))
        plt.ylabel('Cost')
        plt.xlabel('training steps')
        plt.savefig('.\\dataDouble\\'+name+'cost.svg',format='svg',dpi=400)
        plt.savefig('.\\dataDouble\\'+name+'cost.png',format='png',dpi=400) 
